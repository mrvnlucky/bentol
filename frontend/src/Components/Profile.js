                    ...
                    <div className='flex flex-col'>
                        <div className='m-8'>
                            ...
                            <div className='m-3 ml-0 flex flex-row'>
                                <label for='name' className='text-3xl font-bold w-1/4'>Nama</label>
                                <span className='w-3/4 text-3xl font-bold text-dark-blue'>Devara Hipz</span>
                            </div>
                            <div className='m-3 ml-0 flex flex-row'>
                            ...
                            <button class="m-3 ml-0 h-9 px-10 bg-blue hover:bg-black rounded-lg text-white place-item-start">Edit</button>
                        </div>
                        <div className='m-8'>
                            ...
                            <div className='m-3 ml-0 flex flex-row'>
                                ...
                                <span className='w-3/4 text-3xl font-bold text-dark-blue'>Honda</span>
                            </div>
                            <div className='m-3 ml-0 flex flex-row'>
