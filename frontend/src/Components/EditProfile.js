                    ...
                    <div className='flex flex-col'>
                        <div className='m-8'>
                            ...
                            <div className='m-3 ml-0 flex flex-row'>
                                <label for='name' className='text-3xl font-bold w-1/3'>Nama</label>
                                <input type='name' className='mb-3.5 border border-silver rounded w-1/3 p-1 pl-2' placeholder='Masukkan Nama Lengkap'></input>
                                <div className='w-2/3'></div>
                            </div>
                            <div className='m-3 ml-0 flex flex-row'>
                                <label for='email' className='text-3xl font-bold w-1/3'>E-mail</label>
