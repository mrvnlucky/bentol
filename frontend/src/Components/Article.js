            ...
            <div className='grid grid-cols-2 justify-items-center m-4 mt-8 font-nunito gap-y-10 tracking-wide'>
                <div class="max-w-xl bg-white rounded-lg border border-white shadow-lg">
                    ...
                    <div className='flex flex-row justify-between p-5'>
                        ...
                        <a href="#" className="inline-flex float-right items-center mb-0 py-2 px-3 text-lg font-bold text-center text-black bg-white rounded-lg hover:underline">
                            Lihat Artikel
                ...
                <div class="max-w-xl bg-white rounded-lg border border-white shadow-lg">
                    ...
                    <div class="p-5">
                        <a href="#">
                            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 text-black">Pertamax Naik, Apakah Pertalite Juga?</h5>
                        </a>
                        <p class="mb-3 font-bold text-gray-700 text-blue">Kamis, 7 April 2022</p>
                    </div>
                    <div className='flex flex-row justify-between p-5'>
