            ...
            <div class="container flex flex-wrap justify-between items-center mx-auto">
                ...
                <div className='flex'>
                    <a href="/" class="flex">
                        ...
                        <span class="self-center ml-2 text-sm whitespace-nowrap dark:text-white">PROFIL</span>
                    </a>
                    <a href="/" class="ml-12 flex">
                        <img src={Exit} alt='logo bentol' className='w-8' />
                        <span class="self-center ml-2 text-sm whitespace-nowrap dark:text-white">KELUAR</span>
                    </a>
                </div>
            </div>
        </nav>
